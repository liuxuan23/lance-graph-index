...
pub use index::{
    AdjacencyChunk, AdjacencyLookupOptions, CoveringAdjacencyCompression, CoveringAdjacencyIndex,
    CoveringAdjacencyIndexBuilder, CoveringAdjacencyIndexHandle, CoveringAdjacencyIndexStore,
    CoveringAdjacencyLoadOptions, CoveringAdjacencyMetadata, CoveringAdjacencyMetrics,
    CoveringAdjacencyMetricsSnapshot, CoveringAdjacencyReference, CoveringAdjacencyWriteOptions,
    CoveringComponentDescriptorRef, CsrIndexHandle, CsrIndexLoadOptions, CsrIndexStore,
    CsrIndexWriteOptions, DirectAdjacencyIndexBuilder, DirectAdjacencyIndexHandle,
    DirectAdjacencyIndexStore, DirectAdjacencyLoadOptions, DirectAdjacencyMetadata,
    DirectAdjacencyReference, DirectAdjacencyWriteOptions, ExpandExecutionMode,
    ExpandIndexReference, ExpandPlanDecision, GraphIndexKey, GraphIndexMetadata,
    GraphIndexRegistry, GraphSourceIdentity, InMemoryGraphIndexRegistry, IndexDirection,
    IndexReference, IndexSourceValidation, MultiTypeCoveringAdjacencyIndexBuilder,
    MultiTypeCoveringAdjacencyIndexHandle, MultiTypeCoveringAdjacencyIndexStore,
    MultiTypeCoveringAdjacencyLoadOptions, MultiTypeCoveringAdjacencyMetadata,
    ...
    MultiTypeDirectAdjacencyMetadata, MultiTypeSourceValidation,
    PersistedCoveringAdjacencyDescriptor, PersistedCsrIndexDescriptor,
    PersistedDirectAdjacencyDescriptor, PersistedMultiTypeCoveringAdjacencyDescriptor,
    PersistedMultiTypeDirectAdjacencyDescriptor, COVERING_ADJACENCY_INDEX_FORMAT_VERSION,
